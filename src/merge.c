...
/*   Updated: 2023/03/01 20:13:36 by kdaniely         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ascending_merge(t_vector v_head, t_vector v_end,
...
static void	descending_merge(t_vector v_head, t_vector v_end,
							t_stack **head_a, t_stack **head_b)
{
	while (v_head.start || v_end.start)
...
void	merge(t_stack **head_a, t_stack **head_b)
{
	...
	{
		if (v_head.direction == ASCENDING && (v_head.end == v_end.start))
			flush_end(v_end, head_a, head_b);
		else
